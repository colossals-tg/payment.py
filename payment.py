...
API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkF1dGhIdWIiLCJ0eXAiOiJKV1QifQ.eyJ1c2VySWQiOiI3ZGY0MzZlNS1lNWM4LTQxOGYtYmI0YS1hYWI3YWZmNjA1NjciLCJleHAiOjIwODc3NTY0OTYsImlzcyI6IkF1dGhIdWIiLCJhdWQiOiJSZXNvdXJjZXMifQ.4uiefVsmWLZ2Ciepve93lRrCPTWVYC37J3VP_rtMWxI"
...
async def amount_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if payment:
        await update.message.reply_text(payment["url"])
...
def webhook():
    ...
    if user_id:
        asyncio.run(telegram_app.bot.send_message(chat_id=int(user_id), text=status))
